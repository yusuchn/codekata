...
class Ship(object):
    ...
    @property
    def size(self):
        """Gets the size of this Ship.  # noqa: E501

        The length of the ship, in grid cells  # noqa: E501

        :return: The size of this Ship.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    def size(self, size):
        ...
        :param size: The size of this Ship.  # noqa: E501
        :type: int
        """
        if size is None:
