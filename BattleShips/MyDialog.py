...
class MyDialog_DefineGameID(tkSimpleDialog.Dialog):
    ...
    def validate(self):
        ...
        if self.game_id == '':
            messageBox.showwarning(
                'info', 'if no game_id provided, default will be used',
                icon="info")
            # return 0      # default game_id will be provided in BattleShips.py
