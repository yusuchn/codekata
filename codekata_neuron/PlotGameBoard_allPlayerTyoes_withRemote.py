...
# # the enum dictionary is for randomly chosing a move for the computer player
# possible_moves_enum = {0: 'E',  # : e_move,
#                        1: 'NE',  # : ne_move,
#                        2: 'N',  # : n_move,
#                        3: 'NW',  # : nw_move,
#                        4: 'W',  # : w_move,
...
#                        7: 'SE'  # : se_move
#                        }
# print('Debug: enum_moves = {}'.format(possible_moves_enum))
#
# old_row_index_me = -1
# old_col_index_me = -1
...
# game_result = 'none'
#
# # these are the results of is_valid_step function
# # keep it global for computer player, i.e. should a randomly chosen move is invalidm carry on choosing
# # available values: 'none', 'valid', and 'invalid'
# is_valid_step_result = 'none'
#
# draw_debug = False
#
#
# # game configuration values from the popup dialog
# # selected_player_list = {'0': 'me_human', '1': 'another_human'}
# # me_player = 'me_human'
# # another_player = 'another_human'
# # NOTE, do not use StringVar or IntVar as cannot call find on a StringVar obj
# selected_player_list = {}
# me_player = 'none'
# another_player = 'none'
# me_player_play_order = -1
# another_player_play_order = -1
#
# if draw_debug:
...
#
#
# def is_valid_step(current_row_index, old_row_index, current_col_index, old_col_index, attempted_step_completed):
#     print('function: {}'.format(sys._getframe().f_code.co_name))
#     global grid_images
#     global steps
...
#     global game_result
#     global me_player
#     global another_player
#     global me_player_play_order
#     global another_player_play_order
#
#     your_turn = step_completed_another == 0 or step_completed_another == len(steps.keys())-1
#     if not your_turn:
#         messagebox.showwarning('Warning',
#                                'the other player has not yet completed their move, please wait',
#                                icon='info')
#     elif me_player == 'me_computer' and me_player_play_order == 0:
#         if messagebox.askyesno('Computer speaking...',
#                             'me_player ({}) is not human, '
#                             'left mouse click is invalid, computer play?'.format(me_player)):
#             me_player_play_order = -1
#             another_player_play_order = -1
#             computer_move(me_player)
#     elif me_player_play_order == 1:
#         messagebox.showwarning('Warning',
#                                'me_player_play_order = {}, another_player_play_order = {}, \n'
#                                'the other player has not yet completed their move, please wait'.format(
#                                    me_player_play_order, another_player_play_order),
#                                icon="info")
#     else:
#         x, y = event.x, event.y
...
#             ))
#         else:
#             me_move(row_index, col_index, 'me_human')
#             # game started, no need for me_player_play_order and another_player_play_order now, reset
#             me_player_play_order = -1
#             another_player_play_order = -1
#             # we are in click_me function, so me_player must be me_human, and just played a step
#             # (see me_move above), so, if me_player has completed all steps, i.e.
#             # step_completed_me == 0 (see if statement below), start computer_move if another_player is another_computer
#             if (step_completed_me == 0 and
#                 game_result == 'me move completed' and
#                 another_player == 'another_computer'):
#                 if messagebox.askyesno("Computer speaking...",
#                                        'your move completed, move result = {}, My turn?'.format(game_result)):
#                     computer_move(another_player)
#
#
# def computer_v_computer():
#     print('function: {}'.format(sys._getframe().f_code.co_name))
#     global me_player
#     global anohter_player
#     global me_player_play_order
#     global another_player_play_order
#     global game_result
#     global step_completed_me
#     global step_completed_another
#
#     game_over = game_result == 'game over, you won' or game_result == 'game over, you lost'
#     # set the initial step result values to start the game
#     me_first = me_player_play_order > another_player_play_order
#     if me_first:
#         step_completed_another = 0
#         game_result = 'another move completed'
#     else:
#         step_completed_me = 0
#         game_result = 'me move completed'
#
#     # no need for me_player_play_order and another_player_play_order now, reset
#     me_player_play_order = -1
#     another_player_play_order = -1
#
#     while not game_over:
#         # NOTE, computer_move calls either me_move or another_move, which would set
#         # step_completed_me or step_completed_another value accordingly
#         if (me_first):
#             if (step_completed_another == 0 and
#                 game_result == 'another move completed' and
#                 me_player == 'me_computer'):
#                 messagebox.askyesno("Computer speaking...",
#                                     'I am {}, my turn to move?'.format(me_player))
#                 computer_move(me_player)
#             elif (step_completed_me == 0 and
#                   game_result == 'me move completed' and
#                   another_player == 'another_computer'):
#                 messagebox.askyesno("Computer speaking...",
#                                     'I am {}, my turn to move?'.format(another_player))
#                 computer_move(another_player)
#         else:
#             if (step_completed_me == 0 and
#                   game_result == 'me move completed' and
...
#                                     'I am {}, my turn to move?'.format(another_player))
#                 computer_move(another_player)
#             elif (step_completed_another == 0 and
#                   game_result == 'another move completed' and
#                   me_player == 'me_computer'):
#                 messagebox.askyesno("Computer speaking...",
#                                     'I am {}, my turn to move?'.format(me_player))
...
#     global step_completed_me
#     global grid_images
#     global possible_moves_enum
#     print('Debug: another_computer starts moving...')
#     # the following is just for adding the another_computer here:
#     # step 1: find the neutron, and start the move, this is equivalent to neutron_piece_picked
#     if (computer_player.find('another')) != -1:
#         step_completed_another = 0
#     else:
#         step_completed_me = 0
#     # initialise default neutron and player piece indices as they will be used as 'global' in the loop
#     # NOTE, only need to find the initial neutron and player pieces before the whole 4-step move completed
#     neutron_row_index = 3
#     neutron_col_index = 3
#     for m in range(total_row):
#         for n in range(total_col):
#             if grid_images[m][n] == cell_images['neutron']:
#                 neutron_row_index = m
#                 neutron_col_index = n
#                 break
#     print('Current neutron position neutron_row_index = {}, neutron_col_index = {}'.format(
#         neutron_row_index, neutron_col_index
#     ))
#     computer_pieces = {}
#     computer_pieces_count = 0
#     for m in range(total_row):
#         for n in range(total_col):
#             if grid_images[m][n] == cell_images[computer_player]:
#                 computer_pieces[computer_pieces_count] = [m, n]
#                 computer_pieces_count += 1
#     print('computer_pieces = {}, computer_pieces_count = {}'.format(
#         computer_pieces, computer_pieces_count
#     ))
#     chosen_player_piece_row_index = 1
#     chosen_player_piece_col_index = 1
#     # NOTE, don't use the while game_result... loop, easily get trapped
#     # while game_result != 'another move completed':
#     # every move consists of 4 steps: neutron_piece_picked, neutron_piece_dropped,
#     # player_piece_picked, player_piece_dropped
#     for i in range(4):
#         # NOTE, as step_completed_another will be updated as computer_player is making the moves
#         # the attemped_step_completed is being updated too
#         if (computer_player.find('another')) != -1:
#             attemped_step_completed = step_completed_another + 1
#         else:
#             attemped_step_completed = step_completed_me + 1
#         print('Debug: {}, attemped_step_completed = {}'.format(
#             computer_player, attemped_step_completed
#         ))
#         if steps[attemped_step_completed].find('neutron') != -1:
#             if steps[attemped_step_completed].find('picked') != -1:
#                 print('Debug: {} is picking neutron from current position, '
#                       'neutron_row_index = {}, neutron_col_index = {}'.format(
#                         computer_player, neutron_row_index, neutron_col_index
#                 ))
#                 # NOTE, need to call the another_move to set cell color and update the step count
#                 if (computer_player.find('another')) != -1:
#                     another_move(neutron_row_index, neutron_col_index, computer_player)
#                 else:
#                     me_move(neutron_row_index, neutron_col_index, computer_player)
#             elif steps[attemped_step_completed].find('dropped') != -1:
#                 # NOTE, when dropping neutron, do not update neutron_row_index and neutron_col_index,
#                 #       instead, use those values to find the possible moves for neutron, and, choose
#                 #       a move either randomly or based on a algorithmic scoring function
#                 neutron_possible_moves = possible_move_generator(neutron_row_index, neutron_col_index)
#                 # NOTE, another_move calls is_valid_step and updates is_valid_step result value
#                 #       check the results if randomly chosen an invalid step, try to chose again
#                 # NOTE, try a random step anyway, only enter while loop if randomly chosen step is invalid
#                 # TODO, simple evaluation function to choose the best move, e.g.
#                 #  count from the 8 possible moves, which moves most cells?
#                 #  if the same, chose the random move
#                 chosen_neutron_move_index = random.randint(0, len(neutron_possible_moves)-1)
#                 chosen_neutron_move_row_index = \
#                     neutron_possible_moves[possible_moves_enum[chosen_neutron_move_index]][0]
#                 chosen_neutron_move_col_index = \
#                     neutron_possible_moves[possible_moves_enum[chosen_neutron_move_index]][1]
#                 print('Debug: {} is dropping neutron to, '
#                       'chosen_neutron_move_index = {}, '
#                       'chosen_neutron_move_row_index = {}, '
#                       'chosen_neutron_move_col_index = {}'.format(
#                         computer_player,
#                         chosen_neutron_move_index,
#                         chosen_neutron_move_row_index,
#                         chosen_neutron_move_col_index
#                 ))
#                 if (computer_player.find('another')) != -1:
#                     another_move(chosen_neutron_move_row_index, chosen_neutron_move_col_index, computer_player)
#                 else:
#                     me_move(chosen_neutron_move_row_index, chosen_neutron_move_col_index, computer_player)
#                 while is_valid_step_result == 'invalid':
#                     chosen_neutron_move_index = random.randint(0, len(neutron_possible_moves)-1)
#                     chosen_neutron_move_row_index = \
#                         neutron_possible_moves[possible_moves_enum[chosen_neutron_move_index]][0]
#                     chosen_neutron_move_col_index = \
...
#                     else:
#                         me_move(chosen_neutron_move_row_index, chosen_neutron_move_col_index, computer_player)
#         elif steps[attemped_step_completed].find('player') != -1:
#             if steps[attemped_step_completed].find('picked') != -1:
#                 # NOTE, only set the chosen piece index when picking up,
#                 #       when dropping, simply drop the same piece in the new location
#                 # NOTE, try a random step anyway, only enter while loop if randomly chosen step is invalid
#                 # TODO, simple evaluation function to choose the best player, e.g.
#                 #  wihch player piece has the most moves that is not the same as the current index,
#                 #  if the same, chose the random move
#                 chosen_player_piece_index = random.randint(0, computer_pieces_count)
#                 chosen_player_piece_row_index = computer_pieces[chosen_player_piece_index][0]
#                 chosen_player_piece_col_index = computer_pieces[chosen_player_piece_index][1]
#                 # NOTE, need to call the another_move to set cell color and update the step count
#                 print('Debug: {} is picking a player piece, '
#                       'chosen_player_piece_index = {}, '
#                       'chosen_player_piece_row_index = {}, '
#                       'chosen_player_piece_col_index = {}'.format(
#                         computer_player,
#                         chosen_player_piece_index,
#                         chosen_player_piece_row_index,
#                         chosen_player_piece_col_index
#                 ))
#                 if (computer_player.find('another')) != -1:
#                     another_move(chosen_player_piece_row_index, chosen_player_piece_col_index, computer_player)
#                 else:
#                     me_move(chosen_player_piece_row_index, chosen_player_piece_col_index, computer_player)
#                 while is_valid_step_result == 'invalid':
#                     chosen_player_piece_index = random.randint(0, computer_pieces_count)
#                     chosen_player_piece_row_index = computer_pieces[chosen_player_piece_index][0]
#                     chosen_player_piece_col_index = computer_pieces[chosen_player_piece_index][1]
...
#                     ))
#                     if (computer_player.find('another')) != -1:
#                         another_move(chosen_player_piece_row_index,
#                                      chosen_player_piece_col_index,
#                                      computer_player)
#                     else:
#                         me_move(chosen_player_piece_row_index,
#                                 chosen_player_piece_col_index,
#                                 computer_player)
#             elif steps[attemped_step_completed].find('dropped') != -1:
#                 # NOTE, when dropping player piece, do not update chosen_player_piece_row_index and
#                 #       chosen_player_piece_col_index, instead, use values set in picking step to
#                 #       determine the possible moves for the chosen player piece, and, choose
#                 #       a move either randomly or based on a algorithmic scoring function
#                 chosen_player_piece_possible_moves = \
#                     possible_move_generator(chosen_player_piece_row_index, chosen_player_piece_col_index)
#                 # NOTE, another_move calls is_valid_step and updates is_valid_step result value
#                 #       check the results if randomly chosen an invalid step, try to chose again
#                 # NOTE, try a random step anyway, only enter while loop if randomly chosen step is invalid
#                 # TODO, simple evaluation function to choose the best move, e.g.
#                 #  count from the 8 possible moves, which moves most cells?
#                 #  if the same, chose the random move
#                 chosen_player_piece_chosen_move_index = random.randint(
#                     0, len(chosen_player_piece_possible_moves)-1)
#                 chosen_player_piece_chosen_move_row_index = \
#                     chosen_player_piece_possible_moves[
#                         possible_moves_enum[chosen_player_piece_chosen_move_index]][0]
#                 chosen_player_piece_chosen_move_col_index = \
#                     chosen_player_piece_possible_moves[
#                         possible_moves_enum[chosen_player_piece_chosen_move_index]][1]
#                 print('Debug: {} is dropping player piece, '
#                       'chosen_player_piece_chosen_move_index = {}, '
#                       'chosen_player_piece_chosen_move_row_index = {}, '
#                       'chosen_player_piece_chosen_move_col_index = {}'.format(
#                         computer_player,
#                         chosen_player_piece_chosen_move_index,
#                         chosen_player_piece_chosen_move_row_index,
#                         chosen_player_piece_chosen_move_col_index
#                 ))
#                 if (computer_player.find('another')) != -1:
#                     another_move(chosen_player_piece_chosen_move_row_index,
#                                  chosen_player_piece_chosen_move_col_index,
#                                  computer_player)
#                 else:
#                     me_move(chosen_player_piece_chosen_move_row_index,
#                             chosen_player_piece_chosen_move_col_index,
#                             computer_player)
#                 while is_valid_step_result == 'invalid':
#                     chosen_player_piece_chosen_move_index = random.randint(
...
#                                 chosen_player_piece_chosen_move_col_index,
#                                 computer_player)
#         # NOTE, only increment i after a valid step
#         i += 1
#
#
# def me_move(row_index, col_index, player):
#     print('function: {}'.format(sys._getframe().f_code.co_name))
#     global old_row_index_me
#     global old_col_index_me
#     global current_player
...
#     if is_valid_step(row_index, old_row_index_me, col_index, old_col_index_me,
#                      attempted_step_completed):
#         if steps[attempted_step_completed].find('piece_picked') != -1:
...
#                                'the other player has not yet completed their move, please wait',
#                                icon="info")
#     # elif another_player == 'another_computer' and another_player_play_order == 0:
#     #     if messagebox.askyesno('Computer speaking...',
#     #                            'another_player ({}) is not human, '
#     #                            'right mouse click is invalid, computer play?'.format(me_player)):
#     #         another_player_play_order = -1
#     #         me_player_play_order = -1
#     #         computer_move(another_player)
#     elif another_player_play_order == 1:
#         messagebox.showwarning('Warning',
#                                'another_player_play_order = {}, me_player_play_order = {}, \n'
#                                'the other player has not yet completed their move, please wait'.format(
#                                    another_player_play_order, me_player_play_order),
#                                icon="info")
#     else:
...
#             ))
#         else:
#             another_move(row_index, col_index, 'another_human')
#             # game started, no need for me_player_play_order and another_player_play_order now, reset
#             another_player_play_order = -1
#             me_player_play_order = -1
#             # we are in click_another function, so another_player must be another_human, and just played a step
#             # (see another_move above), so, if another_player has completed all steps, i.e.
#             # step_completed_another == 0 (see if statement below), start computer_move if me_player is me_computer,
#             if (step_completed_another == 0 and
#                 game_result == 'another move completed' and
#                 me_player == 'me_computer'):
#                 if messagebox.askyesno("Computer speaking...",
...
#
#
# def another_move(row_index, col_index, player):
#     print('function: {}'.format(sys._getframe().f_code.co_name))
#     global old_row_index_another
#     global old_col_index_another
#     global current_player
...
#     if is_valid_step(row_index, old_row_index_another, col_index, old_col_index_another,
#                      attempted_step_completed):
#         if steps[attempted_step_completed].find('piece_picked') != -1:
#             show_possible_moves(row_index, col_index)
#         elif steps[attempted_step_completed].find('piece_dropped') != -1:
...
#
# def main():
#     # values specified by the popup dialog
#     global selected_player_list
#     global me_player
#     global another_player
#     global me_player_play_order
#     global another_player_play_order
#     start_human_v_computer = False
#     start_computer_v_computer = False
#
#     # Note, to initialise the board, pass a hard coded zero to draw the board cell in blue
#     # if MyDialog_ChoosePlayer(root):
#     d = MyDialog_ChoosePlayer(root)
#     selected_player_list = d.result
#     if selected_player_list:
#         print('selected_players are: {}'.format(selected_player_list))
#         # NOTE, selected_player_list only ever has two players, one me player, one another player,
#         # see MyDialog_ChoosePlayer
#         i = 1
#         player1 = 'none'
#         player2 = 'none'
#         player1_play_order = -1
#         player2_play_order = -1
#         for key, value in selected_player_list.items():
#             if i == 1:
#                 player1 = value
#                 player1_play_order = int(key)
#             elif i == 2:
#                 player2 = value
#                 player2_play_order = int(key)
#                 break
#             i += 1
#         print('player1 = {}, player1_play_order = {}, player2 = {}, player2_play_order = {}'.format(
#             player1, player1_play_order, player2, player2_play_order))
#
#         if player1.find('me_') != -1:
#             me_player_play_order = player1_play_order
#             another_player_play_order = player2_play_order
#         else:
#             me_player_play_order = player2_play_order
#             another_player_play_order = player1_play_order
#
#         if ((player1 == 'me_human' and player2 == 'another_human') or
#             (player2 == 'me_human' and player1 == 'another_human')):
#             me_player = 'me_human'
#             another_player = 'another_human'
#             messagebox.showinfo("Game starting...",
#                                 'me_player = {}, me_player_play_order = {}, '
#                                 'another_player = {}, another_player_play_order = {}, '
#                                 'use left mouse for me, and right mouse for another to start the game'.format(
#                                     me_player, me_player_play_order, another_player, another_player_play_order),
#                                 icon="info")
#         elif ((player1 == 'me_human' and player2 == 'another_computer') or
#               (player2 == 'me_human' and player1 == 'another_computer')):
#             me_player = 'me_human'
#             another_player = 'another_computer'
#             messagebox.showinfo("Gamw starting...",
#                                 'me_player = {}, me_player_play_order = {}, '
#                                 'another_player = {}, another_player_play_order = {}, '
#                                 'use left mouse for me, another is computer'.format(
#                                     me_player, me_player_play_order, another_player, another_player_play_order),
#                                 icon="info")
#             # NOTE, any move needs to be moved to after draw_game_board and canvas.bind
#             start_human_v_computer = True
#         elif ((player1 == 'me_human' and player2 == 'another_remote') or
#               (player2 == 'me_human' and player1 == 'another_remote')):
#             me_player = 'me_human'
#             another_player = 'another_remote'
#             messagebox.showinfo("Gamw starting...",
#                                 'me_player = {}, me_player_play_order = {}, '
#                                 'another_player = {}, another_player_play_order = {}, '
#                                 'me_human against another_remote, not implemented yet'.format(
#                                     me_player, me_player_play_order, another_player, another_player_play_order),
#                                 icon="info")
#         elif ((player1 == 'me_computer' and player2 == 'another_human') or
#               (player2 == 'me_computer' and player1 == 'another_human')):
#             me_player = 'me_computer'
#             another_player = 'another_human'
#             messagebox.showinfo("Game starting...",
#                                 'me_player = {}, me_player_play_order = {}, '
#                                 'another_player = {}, another_player_play_order = {}, '
#                                 'use right mouse for another, me is computer'.format(
#                                     me_player, me_player_play_order, another_player, another_player_play_order),
#                                 icon="info")
#             # NOTE, any move needs to be moved to after draw_game_board and canvas.bind
#             start_human_v_computer = True
#         elif ((player1 == 'me_computer' and player2 == 'another_computer') or
#               (player2 == 'me_computer' and player1 == 'another_computer')):
#             me_player = 'me_computer'
#             another_player = 'another_computer'
#             messagebox.showinfo("Game starting...",
#                                 'me_player = {}, me_player_play_order = {}, '
#                                 'another_player = {}, another_player_play_order = {}, '
#                                 'computer is playing computer'.format(
#                                     me_player, me_player_play_order, another_player, another_player_play_order),
#                                 icon="info")
#             # NOTE, any move needs to be moved to after draw_game_board and canvas.bind
#             start_computer_v_computer = True
#         elif ((player1 == 'me_computer' and player2 == 'another_remote') or
#               (player2 == 'me_computer' and player1 == 'another_remote')):
#             me_player = 'me_computer'
#             another_player = 'another_remote'
#             messagebox.showinfo("Game starting...",
#                                 'me_player = {}, me_player_play_order = {}, '
#                                 'another_player = {}, another_player_play_order = {}, '
#                                 'me is computer, playing against another remote player, not implemented yet'.format(
#                                     me_player, me_player_play_order, another_player, another_player_play_order),
#                                 icon="info")
#         reset_grid_pattern()
#         draw_game_board(canvas)
...
#         if start_human_v_computer:
#             if another_player == 'another_computer' and another_player_play_order == 0:
#                 if messagebox.askyesno('Computer speaking...',
#                                        'another_player_play_order = {}, another_player ({}) is not human, '
#                                        'right mouse click is invalid, computer play?'.format(
#                                            another_player_play_order, me_player)):
#                     another_player_play_order = -1
#                     me_player_play_order = -1
#                     computer_move(another_player)
#             elif me_player == 'me_computer' and me_player_play_order == 0:
...
games = requests.get('http://10.44.37.98:8080/games/')
print(games.json())

gameids = requests.get('http://10.44.37.98:8080/games/140412789000736/')
print(gameids.json())
