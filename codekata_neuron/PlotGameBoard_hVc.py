...
def click_me(event):
    ...
    if not your_turn:
        ...
        if row_index > total_row-1 or col_index > total_col-1:
            ...
            # if me completed all 4 steps and step_comppleted_me has been reset to 0, start another_computer move
            if step_completed_me == 0 and game_result == 'me move completed':
                if messagebox.askyesno("Computer", 'your move completed, move result = {}, My turn?'.format(game_result)):
                    computer_move('another_computer')
