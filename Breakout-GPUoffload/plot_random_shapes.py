...
# # NOTE, the following is for plotting the images in separate, somewhat configurable figure window
# # and, these two lines have to be above "import matplotlib.pyplot as plt"
# import matplotlib
